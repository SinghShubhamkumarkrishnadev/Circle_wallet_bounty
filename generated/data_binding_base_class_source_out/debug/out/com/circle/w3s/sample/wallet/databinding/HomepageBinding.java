...
public final class HomepageBinding implements ViewBinding {
  ...
  private HomepageBinding(@NonNull ConstraintLayout rootView, @NonNull Button SendBtn,
      ...
      @NonNull Button copyButton, @NonNull EditText editTextSearch,
      @NonNull TextView ethTokenBalanceText, @NonNull Button logoutButton,
      @NonNull Button receiveBtn, @NonNull RecyclerView recyclerViewContacts,
      @NonNull Button refreshbutton, @NonNull TextView statusLoadingTextView,
      @NonNull TextView textView, @NonNull TextView tokenBalance,
      @NonNull TextView usdcTokenBalanceText, @NonNull ImageView usdclogoImageView,
      @NonNull Button viewTransactionBtn, @NonNull TextView walletAddressTextView) {
  ...
  public static HomepageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HomepageBinding((ConstraintLayout) rootView, SendBtn, avaxlogoImageView,
          avaxlogoImageView2, copyButton, editTextSearch, ethTokenBalanceText, logoutButton,
          receiveBtn, recyclerViewContacts, refreshbutton, statusLoadingTextView, textView,
          tokenBalance, usdcTokenBalanceText, usdclogoImageView, viewTransactionBtn,
